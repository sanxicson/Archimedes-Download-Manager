...
A modern, open-source fork of Internet Download Manager (IDM) built with React, Express, Vite, and Electron. Archimedes Download Manager brings IDM-style accelerated downloading to the web and desktop with a classic, instantly recognizable interface.
...
![Status](https://img.shields.io/badge/status-beta-yellow) ![Version](https://img.shields.io/badge/version-0.6-blue) ![License](https://img.shields.io/badge/license-MIT-green)
...
MIT — use, modify, and distribute freely. See the `LICENSE` file for details.
